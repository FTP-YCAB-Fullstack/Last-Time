...
const AddOffice = ({token}) => {
    ...
    return (
        <div className="dark:text-gray-100 my-8">
            <h1 className="text-2xl font-semibold">Tambah Kantor</h1>
            <form onSubmit={handleSubmit(onSubmit)} className="md:w-1/2">
                ...
                <div className="flex justify-between">
                    <Link to="/admin/users">
                        <button type="button" className="flex flex-row gap-2 bg-gray-400 text-white dark:bg-gray-600 font-semibold py-2 px-4 rounded hover:bg-gray-500 transition duration-200">
